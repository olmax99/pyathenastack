...
class FlaskRedis(object):
    """
    This is a custom implementation using the redis connection from environment variables (see init_app.redis_url)
    More info at http://flask.pocoo.org/docs/0.12/extensiondev/
    ...
    def init_app(self, app, **kwargs):
        redis_url = app.config.get(
            '{0}_URI'.format(self.config_prefix),
